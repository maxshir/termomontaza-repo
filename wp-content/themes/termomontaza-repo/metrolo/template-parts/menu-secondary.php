...
if ( has_nav_menu( 'secondary' ) ) : // Check if there's a menu assigned to the 'secondary' location.
	...
	?>
	<h3 class="screen-reader-text"><?php _e( 'Secondary Navigation Menu', 'metrolo' ); ?></h3>
	<nav <?php hybridextend_attr( 'menu', 'secondary' ); ?>>
		<div class="menu-toggle"><span class="menu-toggle-text"><?php _e( 'Menu', 'metrolo' ); ?></span><i class="fa fa-bars"></i></div>
