...
add_filter( 'hybrid_attr_menu', 'hoot_theme_attr_menu', 5, 2 );
add_filter( 'hybrid_attr_content', 'hoot_theme_attr_content' );
add_filter( 'hybrid_attr_sidebar', 'hoot_theme_attr_sidebar', 10, 2 );
add_filter( 'hybrid_attr_branding', 'hoot_theme_attr_branding', 5 );
add_filter( 'hybrid_attr_entry-summary', 'hoot_theme_attr_entry_summary', 5, 2 );
...
add_filter( 'hybrid_attr_loop-meta-wrap', 'hoot_theme_attr_loop_meta_wrap', 5 );
add_filter( 'hybrid_attr_loop-meta', 'hoot_theme_attr_loop_meta', 5 ); // hybrid_attr_archive-header in v3.0.0 ; we use it for generic loop (archive / singular etc )
add_filter( 'hybrid_attr_loop-title', 'hoot_theme_attr_loop_title', 5 ); // hybrid_attr_archive-title in v3.0.0 ; we use it for generic loop (archive / singular etc )
add_filter( 'hybrid_attr_loop-description', 'hoot_theme_attr_loop_description', 5 ); // hybrid_attr_archive-description in v3.0.0 ; we use it for generic loop (archive / singular etc )
...
add_filter( 'hybrid_attr_content-block-img', 'hoot_theme_attr_content_block_img' );
...
function hoot_theme_attr_content_block_img( $attr ) {
	$attr['class'] = ( empty( $attr['class'] ) ) ? '' : $attr['class'];
	$attr['alt'] = __( 'Content Image', 'metrolo' );
	$attr['itemprop'] = 'image';
	return $attr;
}
