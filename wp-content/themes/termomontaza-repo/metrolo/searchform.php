...
$searchlabel = apply_filters( 'hoot_search_form_label', __( 'Search', 'metrolo' ) );
$searchplaceholder = apply_filters( 'hoot_search_form_placeholder', __( 'Type Search Term &hellip;', 'metrolo' ) );
$searchsubmit = apply_filters( 'hoot_search_form_submit', __( 'Search', 'metrolo' ) );
