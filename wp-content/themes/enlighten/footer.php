            ...
            <div class="site-info">
                ...
                if($enlighten_footer_text){
                    echo enlighten_esc_footer_copyright($enlighten_footer_text);
                         ...
                         printf( esc_html__( '%1$s  %2$s  %3$s', '' ), '&copy; 2017 Termomontaza |' ,'<a target="_blank" href="https://accesspressthemes.com/wordpress-themes/enlighten/" rel="designer"> </a>', '<a target="_blank" href="http://accesspressthemes.com/" rel="designer"> </a>' );
                    }?>
        	</div><!-- .site-info -->
        <?php } ?>
        </div>
