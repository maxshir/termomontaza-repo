                          ...
                          if($enlighten_number){ ?>
                            <div class="phone_header wow fadeIn">
                                ...
                                <div class="title_phone">
                                    <span class="pnone_title"><?php esc_html_e('Telephone','enlighten'); ?></span>
                          ...
                          if($enlighten_email){ ?>
                            <div class="email_header wow fadeIn">
                                ...
                                <div class="title_email_wrap">
                                    <span class="title_email"><?php esc_html_e('Email','enlighten'); ?></span>
                          ...
                          if($enlighten_location){ ?>
                            <div class="location_header wow fadeIn">
                                ...
                                <div class="title_location_wrap">
                                    <span class="title_location"><?php esc_html_e('Ort','enlighten'); ?></span>
