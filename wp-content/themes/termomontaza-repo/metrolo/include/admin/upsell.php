...
function hoot_admin_enqueue_upsell_styles( $hook ) {
	if ( $hook == 'appearance_page_metrolo-premium' )
...
function hoot_theme_appearance_subpage() {
	...
	$hoot_cta = ( empty( $hoot_cta ) ) ? '<a class="button button-primary button-buy-premium" href="http://wphoot.com/" target="_blank">' . __( 'Click here', 'metrolo' ) . '</a>' : $hoot_cta;
